...
SECRET_KEY = '4d!r6*g^zk+^3^a=j!^23ep&8o_&qeaw%%2wei0fx78)!zi99^'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'templates/links'),os.path.join(BASE_DIR, 'templates'),]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.path.join(BASE_DIR,"links/static")
